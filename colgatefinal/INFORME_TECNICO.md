...
## 3. Evolución Arquitectónica: Módulo 2 → Módulo 3
...
|---|---|---|
| Interfaz de usuario | Streamlit (web local) | WhatsApp (canal masivo) |
| Orquestación | LangChain + Python | OpenFang Agent OS (Rust) |
...
### 4.2 Ciclo de vida de un mensaje
...
## 6. Base de Conocimiento Corporativo
...
### 7.2 Hand de monitoreo de servicio
...
### 7.3 Activación — evidencia de ejecución
...
## 10. Incidentes de Producción y Resolución
...
## 11. Análisis t-SNE de Intenciones
